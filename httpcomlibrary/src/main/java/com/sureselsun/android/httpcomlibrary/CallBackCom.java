 ...
 */
public abstract class CallBackCom<T> {
    ...
    public static abstract class CallBackDefault extends CallBackCom<Response>{
        @Override
    ...
    public static abstract class CallBackString extends CallBackCom<String>{
        @Override
    ...
    public static abstract class CallBackBitmap extends CallBackCom<Bitmap>{
     ...
     * 下载文件时的回调类
     */
    public static abstract class CallBackFile extends CallBackCom<File>{
